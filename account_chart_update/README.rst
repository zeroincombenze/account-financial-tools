...
=============================================================================
|icon| Detect changes and update the Account Chart from a template 10.0.1.0.1
=============================================================================


**Wizard to update a company's account chart from a template**

.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/account-financial-tools/10.0/account_chart_update/static/description/icon.png
...
|en| This is a pretty useful tool to update Odoo installations after tax reforms
...
* |menu| Setting > Apps |right_do| Select **account_chart_update** > Install
...
* |menu| Setting > Activate Developer mode
* |menu| Apps > Update Apps List
* |menu| Setting > Apps |right_do| Select **account_chart_update** > Update
