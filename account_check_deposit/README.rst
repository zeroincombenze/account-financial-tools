...
=======================================
|icon| Account Check Deposit 10.0.1.0.0
=======================================


**Manage deposit of checks to the bank**

.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/account-financial-tools/10.0/account_check_deposit/static/description/icon.png
...
|en| This module allows you to easily manage check deposits : you can select all
...
* |menu| Setting > Apps |right_do| Select **account_check_deposit** > Install
...
* |menu| Setting > Activate Developer mode
* |menu| Apps > Update Apps List
* |menu| Setting > Apps |right_do| Select **account_check_deposit** > Update
