...
=====================================
|icon| Account Fiscal Year 10.0.1.0.0
=====================================


.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/account-financial-tools/10.0/account_fiscal_year/static/description/icon.png
...
* |menu| Setting > Activate Developer mode
* |menu| Apps > Update Apps List
* |menu| Setting > Apps |right_do| Select **account_fiscal_year** > Update
