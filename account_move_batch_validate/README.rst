...
=============================================
|icon| Account Move Batch Validate 10.0.1.0.0
=============================================


.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/account-financial-tools/10.0/account_move_batch_validate/static/description/icon.png
...
* |menu| Setting > Apps |right_do| Select **account_move_batch_validate** > Install
...
* |menu| Setting > Activate Developer mode
* |menu| Apps > Update Apps List
* |menu| Setting > Apps |right_do| Select **account_move_batch_validate** > Update
