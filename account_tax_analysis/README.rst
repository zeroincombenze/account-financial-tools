...
==============================
|icon| Tax analysis 10.0.1.0.0
==============================


.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/account-financial-tools/10.0/account_tax_analysis/static/description/icon.png
...
|en| This add-on is a must if you want to be able to validate your VAT form.
...
* |menu| Setting > Apps |right_do| Select **account_tax_analysis** > Install
...
* |menu| Setting > Activate Developer mode
* |menu| Apps > Update Apps List
* |menu| Setting > Apps |right_do| Select **account_tax_analysis** > Update
